...
- **[2c_Evaluate_patient_snapshot_models](https://github.com/UCL-CORU/patientflow/blob/main/notebooks/2c_Evaluate_patient_snapshot_models.ipynb):** Demonstrates the use of convenient functions to help you evaluate predictive models trained on patient snapshots.
...
- **[4d_Evaluate_demand_predictions](https://github.com/UCL-CORU/patientflow/blob/main/notebooks/4d_Evaluate_demand_predictions.ipynb):** Canonical guide to `patientflow.evaluate` — systematic evaluation with `run_evaluation`, benchmarks, and `scalars.json`.
