...
![png](3e_Predict_demand_from_patients_yet_to_arrive_files/3e_Predict_demand_from_patients_yet_to_arrive_15_0.png)
...
![png](3e_Predict_demand_from_patients_yet_to_arrive_files/3e_Predict_demand_from_patients_yet_to_arrive_17_0.png)
...
plot_prob_dist(combined_dist, title,
    include_titles=True, truncate_at_beds=20, bar_colour=colour_dict["single"]["all"])
```

![png](3e_Predict_demand_from_patients_yet_to_arrive_files/3e_Predict_demand_from_patients_yet_to_arrive_27_0.png)
...
_ = yta_model_empirical.fit(train_visits_copy,
...
_ = yta_model_by_spec_empirical.fit(train_visits_copy,
#                        prediction_window=timedelta(hours=8), deprecated; prediction_window is now a parameter of the predict() method
                        yta_time_interval=timedelta(minutes=15),
#                        prediction_times=prediction_times, deprecated; prediction times are now passed at predict() method
                        num_days=num_days,
...
_ = yta_model_parametric.fit(train_visits_copy,
#              prediction_window=timedelta(hours=8), deprecated; prediction_window is now a parameter of the predict() method
              yta_time_interval=timedelta(minutes=15),
#              prediction_times=prediction_times, deprecated; prediction times are now passed at predict() method
              num_days=num_days)
...
![png](3e_Predict_demand_from_patients_yet_to_arrive_files/3e_Predict_demand_from_patients_yet_to_arrive_56_0.png)
